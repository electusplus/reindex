package com.electusplus.reindex.project_settings;
...
import com.electusplus.reindex.reindex_execution_plan_builder.reindex_algorithms.TimeSeriesReindexAlgorithm;
import com.electusplus.reindex.reindex_execution_plan_builder.reindex_algorithms.WholeIndexReindexAlgorithm;
...
public class ReindexSettingsPOJO {
    ...
    public boolean checkIsAtLeastOneDestinationSelected() {
        return isMergeToOneIndex || isSendToAlias || isSendToPipeline || isAddIndexPrefix || isAddIndexSuffix || isUseIlm;
    }
