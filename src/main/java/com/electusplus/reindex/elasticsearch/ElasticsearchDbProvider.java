...
public class ElasticsearchDbProvider {
    ...
    public RestHighLevelClient getHighLevelClient(final EsSettings connectionSettings, String projectId) throws ClusterConnectionException {
    ...
    public RestClient getLowLevelClient(final EsSettings connectionSettings, String projectId) throws ClusterConnectionException {
        return getHighLevelClient(connectionSettings, projectId).getLowLevelClient();
    }

    private RestClientBuilder buildLowLevelRestClient(EsSettings connectionSettings) {
    ...
    private RestClientBuilder addSslToClientBuilder(EsSettings connectionSettings, RestClientBuilder clientBuilder, String projectId) throws ClusterConnectionException{
    ...
    private RestClientBuilder addSslToClientBuilder(EsSettings connectionSettings, RestClientBuilder clientBuilder) throws ClusterConnectionException{
        try {
            CredentialsProvider credentialsProvider = new BasicCredentialsProvider();
            credentialsProvider.setCredentials(AuthScope.ANY,
                    new UsernamePasswordCredentials(connectionSettings.getUsername(), connectionSettings.getPassword()));
...
//            });
    ...
    private RestClientBuilder addBasicAuthenticationToClientBuilder(EsSettings connectionSettings, RestClientBuilder clientBuilder) {
        CredentialsProvider credentialsProvider = new BasicCredentialsProvider();
        credentialsProvider.setCredentials(AuthScope.ANY,
                new UsernamePasswordCredentials(connectionSettings.getUsername(), connectionSettings.getPassword()));
        clientBuilder.setHttpClientConfigCallback(new RestClientBuilder.HttpClientConfigCallback() {
