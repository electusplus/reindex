...
public class ReindexAlgorithmPOJO implements IReindexAlgorithm {
    ...
    public ReindexAlgorithmPOJO(String reindexAlgorithmName, List<AlgorithmParam> algorithmParams, boolean isSelected) {
        this.reindexAlgorithmName = reindexAlgorithmName;
        this.algorithmParams = algorithmParams;
        this.isSelected = isSelected;
    }

    public ReindexAlgorithmPOJO(String reindexAlgorithmName, List<AlgorithmParam> algorithmParams) {
        this.reindexAlgorithmName = reindexAlgorithmName;
        this.algorithmParams = algorithmParams;
    }
    ...
    public static class AlgorithmParam {
        ...
        public AlgorithmParam(String label, String fieldType, Object defaultValue, Object actualValue) {
            this.label = label;
