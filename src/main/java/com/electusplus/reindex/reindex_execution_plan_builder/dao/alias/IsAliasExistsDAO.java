package com.electusplus.reindex.reindex_execution_plan_builder.dao.alias;
...
public class IsAliasExistsDAO implements IClusterTaskDAO {
    ...
    protected boolean executeRequest(GetAliasesRequest request, RestHighLevelClient client) {
        try {
