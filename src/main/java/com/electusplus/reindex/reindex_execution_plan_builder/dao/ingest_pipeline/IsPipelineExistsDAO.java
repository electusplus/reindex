package com.electusplus.reindex.reindex_execution_plan_builder.dao.ingest_pipeline;
...
public class IsPipelineExistsDAO implements IClusterTaskDAO {
    ...
    protected boolean executeRequest(GetPipelineRequest  request, RestHighLevelClient client) {
        try {
