...
public class CreateIndexDAO extends AClusterTaskDAO<CreateIndexRequest> implements IClusterTaskDAO {
    ...
    public CreateIndexDAO(final String requestType, final String... params) {
        super(requestType,params);
        this.request = generateRequest();
    }

    @Override
    protected boolean executeRequest(CreateIndexRequest request, RestHighLevelClient client) {
        try {
    ...
    private CreateIndexRequest createWritenIndexWithAliasRequest(final String alias, final String rolloverIndex) {
