package com.electusplus.reindex.reindex_execution_plan_builder.dao.cluster_health;
...
public class IsClusterRespond implements IClusterTaskDAO {
    ...
    protected boolean executeRequest(ClusterHealthRequest request, RestHighLevelClient client) {
        try {
