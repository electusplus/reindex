package com.electusplus.reindex.reindex_execution_plan_monitoring;
...
public class ReindexTaskStatusPOJO extends BasicStatusPOJO {
    ...
    public ReindexTaskStatusPOJO(String taskId, String sourceIndex, String description, String query, String reindexParams) {
        this.taskId = taskId;
    ...
    public ReindexTaskStatusPOJO(String taskId, String sourceIndex, String description, String query, String reindexParams, Map<String, Object> reprocessParams) {
        this.taskId = taskId;
        this.sourceIndex = sourceIndex;
        this.description = description;
        this.query = query;
    ...
    public synchronized void updateStatus(JsonNode taskResults) {
